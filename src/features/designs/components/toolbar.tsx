...
export const Toolbar = ({ activeTool, onChangeActiveTool }: ToolbarProps) => {
  ...
  if (editor?.selectedObjects.length === 0) {
    return (
      <div className="sticky top-0 z-[49] flex h-[56px] w-full shrink-0 items-center gap-x-2 overflow-x-auto border-b bg-white p-2" />
    );
  }

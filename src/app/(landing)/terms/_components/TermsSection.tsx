      ...
      <div className="prose prose-lg max-w-none">
        ...
        <div className="mt-8">
          <p className="text-gray-600">
            On the website kidbooks.fun ("Site") KidBooks Technologies Inc., 123
            Story Street, San Francisco, CA 94105, United States ("KidBooks")
            provides a platform for creating, editing, sharing and using
            AI-powered story designs (the "KidBooks Platform").
          </p>

          <p className="mt-6 text-gray-600">
            Use of the KidBooks Platform requires that you as the user ("User")
            accept all provisions, rules and conditions of these terms of use
            ("Terms of Use") as well as the license terms ("License Terms")
            which form the basis of the agreement concluded between KidBooks and
            the User ("Contract"). If, for whatever reason the User disagrees
          ...
          <p className="mt-6 text-gray-600">
            ...
            to amend these Terms of Use and/or the License Terms ("Amendment").
            KidBooks will inform the User in the event of a planned Amendment
            about the content of the Amendment with at least four (4) weeks'
            notice to the scheduled date of entry into force; the amended Terms
            of Use and/or the License Terms will only come into effect if the
            User has agreed to the Amendments.
          </p>
          ...
          <p className="mt-6 text-gray-600">
            ...
            these Terms of Use on such company's or organization's behalf.
          </p>
          ...
          <ul className="list-alpha mt-4 list-inside space-y-2 text-gray-600">
            ...
            <li>
              ...
              such as Facebook or Google ("Social Login"); if the User wishes to
              register with the KidBooks Platform by means of Social Login, the
              User will be redirected to the login/registration mask of the
              (social) network and can log in there with his/her user name and
              password stored with this provider ("Login Details").
            </li>
          </ul>
          ...
          <ul className="mt-4 list-inside list-disc space-y-2 text-gray-600">
            <li>
              Upload his/her own photos, designs, or other content ("User
              Uploads"),
            </li>
            <li>
              Use story templates, illustrations or AI models of KidBooks
              ("KidBooks Content") as such, and/or
            </li>
            <li>
              Use KidBooks Content and/or User Uploads to create
              individual(ized) stories on the KidBooks Platform ("User Generated
              Content", User Generated Content and KidBooks Content, together
              the "Content").
            </li>
          </ul>
